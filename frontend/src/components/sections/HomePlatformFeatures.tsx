...
const features = [
  {
    code: "AI",
    title: "AI-інструменти для найму",
    description:
      "AI генерація вакансії допомагає швидко створити драфт, а AI-вижимка резюме дає короткий підсумок і сильні сторони кандидата.",
    ctaLabel: "Спробувати AI-функції",
    ctaTo: "/dashboard",
  },
  {
    code: "CH",
